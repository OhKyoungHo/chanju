                           ...
                           <nav id="mobile-menu">
                              <ul>
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                       <li><a href="index-2">Home Style 1</a></li>
                                       <li><a href="index-2">Home Style 2</a></li>
                                       <li><a href="index-2">Home Style 3</a></li>
                                    </ul>
                                 </li>
                                 <li class="has-dropdown">
                                    ...
                                    <ul class="submenu">
                                       ...
                                       <li><a href="/academy/course-sidebar">Course List</a></li>
                     ...
                     <div class="col-xxl-6 col-xl-6 col-lg-6 col-md-6">
                        <div class="hero__content hero__content-2 p-relative z-index-1">
                           ...
                           <div class="hero__search">
                              <form action="/academy/temp" method="GET" role="search">
